---
title: Host and deploy Blazor and Razor Components
author: guardrex
description: Discover how to host and deploy Blazor and Razor Components apps using ASP.NET Core, Content Delivery Networks (CDN), file servers, and GitHub Pages.
...
---
# Host and deploy Blazor and Razor Components
