...
* [Planning Poker](https://github.com/duracellko/planningpoker4azure) ([Demo](http://planningpoker.duracellko.net)) &ndash; Web application to play Planning Poker for distributed teams. The application is implemented using Blazor and presents, how to switch between Client-side and Server-side mode just by configuration change.
